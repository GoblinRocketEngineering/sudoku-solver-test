// https://raw.githubusercontent.com/AnthonySteele/SudokuSolver/master/SudokuSolver.cs
// --------------------------------------------------------------------------------------------------------------------
...
namespace sudoku.Solvers
{
    ...
    {
        public SimpleSolver(int boardSize)
        {
            BoardSize = boardSize;
        }
        ...
        public static int[,] CopyBoard(int[,] boardData)
        {
            ...
            var xLength = boardData.GetLength(0);
            var yLength = boardData.GetLength(1);
